...
$id = $_GET['id'];
$stmt = $pdo->prepare("SELECT t.*, c.nama_celengan, c.id as celengan_id
...
<head>
    ...
    <title>Edit Transaksi - <?= htmlspecialchars($data['nama_celengan']); ?></title>
...
<body>
    ...
    <div class="form-container">
        <div class="header">
            ...
            <p>Celengan: <strong><?= htmlspecialchars($data['nama_celengan']); ?></strong></p>
        </div>
        ...
        <form action="api/api-edit-transaksi.php" method="POST">
            ...
            <div class="form-group">
                ...
                <select name="tipe" id="tipe" required>
                    <option value="masuk" <?= $data['tipe'] == 'masuk' ? 'selected' : ''; ?>>Masuk (Tambah Saldo)</option>
                    <option value="keluar" <?= $data['tipe'] == 'keluar' ? 'selected' : ''; ?>>Keluar (Kurangi Saldo)</option>
                </select>
            </div>
        ...
        <a href="../dashboard/detail-celengan.php?id=<?= $data['celengan_id']; ?>" class="back-link">
