...
<head>
    ...
    <title>Edit Celengan - <?= htmlspecialchars($celengan['nama_celengan']); ?></title>
...
<body>
    ...
    <div class="form-container">
        <div class="header">
            <h2>Edit Celengan</h2>
            <p>Perbarui informasi celengan Anda</p>
        </div>
        
        <form action="api/api-edit-celengan.php" method="POST">
            <input type="hidden" name="id" value="<?= $celengan['id']; ?>">
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    id="nama_celengan"
                    name="nama_celengan" 
                    value="<?= htmlspecialchars($celengan['nama_celengan']); ?>" 
