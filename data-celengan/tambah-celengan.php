...
<head>
    ...
    <title>Tambah Celengan Baru</title>
...
<body>
    ...
    <div class="form-container">
        <div class="header">
            <h2>Buat Celengan Baru</h2>
            <p>Mulai menabung untuk tujuan Anda</p>
        </div>
        ...
        <form action="api/api-tambah-celengan.php" method="POST">
            <div class="form-group">
                <label for="nama_celengan">Nama Celengan</label>
                <input 
                    type="text" 
                    id="nama_celengan"
                    name="nama_celengan" 
            ...
            <div class="form-group">
                <label for="pengisian">Frekuensi Pengisian</label>
                <select name="pengisian" id="pengisian" required>
                    <option value="harian">Harian</option>
                    <option value="mingguan">Mingguan</option>
                    <option value="bulanan">Bulanan</option>
                </select>
                <div class="info-text">Seberapa sering Anda akan menabung</div>
            </div>
